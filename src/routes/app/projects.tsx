...
function Projects() {
  ...
  return (
    <div className="flex flex-col h-full min-h-0 px-5 lg:px-6 py-4 gap-3.5 overflow-x-hidden">
      ...
      <section className="rounded-2xl bg-black/32 backdrop-blur-xl border border-white/10 md:flex-1 md:min-h-0 flex flex-col md:overflow-hidden overflow-x-hidden">
        ...
        <div className="md:hidden p-3 space-y-3 overflow-x-hidden">
          {projects.map((p) => (
